                     ...
                     costumers: result.map(costumer => {
                         return {
                             ...
                             request: {
                                 ...
                                 url: 'http://localhost:3000/costumers/' + costumer.costumer_id
                                }
                            }
                        })
                ...
                const response = {
                    ...
                    costumers: {
                        ...
                        request: {
                            ...
                            url: 'http://localhost:3000/costumers/details/' + result[0].costumer_id
                        }
                            ...
                            const response = {
                                ...
                                clienteNovo: {
                                    ...
                                    request: {
                                        ...
                                        url: 'http://localhost:3000/costumers/' + result.costumer_id
                                    }
                ...
                const response = {
                    ...
                    ProductUpdated: {
                        ...
                        request: {
                            type: 'GET',
                            description: 'Returns a specific costumer',
                            url: 'http://localhost:3000/costumers' + req.body.costumer_id
                        }
